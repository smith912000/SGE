...
export default function EducationTab({ ctx }) {
  ...
  const Method = ({ title, plain, detail, structure }) => (
    <div style={{ marginBottom: 26 }}>
      ...
      {depth >= 2 && structure && (
        <p style={{ ...deeper, borderLeftColor: `${M3.tertiary}55` }}>{structure}</p>
      )}
    </div>
  );
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <Card style={{ background: `linear-gradient(135deg,${M3.tertiaryContainer}55,${M3.surfaceContainer})`, borderColor: `${M3.tertiary}44` }}>
