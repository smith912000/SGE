              ...
              {gridDays.map(gd => {
                ...
                return (
                  <div key={gd.dom} onClick={() => { setCalDate({ y: gregDate.getFullYear(), m: gregDate.getMonth() + 1, d: gregDate.getDate() }); setCalShowMonth(false); }}
                    style={{
                      padding: "6px 2px", borderRadius: 6, textAlign: "center", cursor: "pointer",
      ...
      {cd.egyptianSolar && (
        <Card title="The Ancient Egyptian Solar (Civil) Calendar" style={{ background: `linear-gradient(135deg,${M3.primaryContainer}22,${M3.surfaceContainer})`, borderColor: `${M3.primary}33` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            {/* Season & Month Info */}
            <div style={{ background: M3.surfaceVariant + "44", padding: "12px", borderRadius: 12, border: `1px solid ${M3.outlineVariant}` }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                <span style={{ fontSize: "1.2rem", color: M3.primary }}>{cd.egyptianSolar.season.hiero}</span>
                <div>
                  <div style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: "0.6rem", color: M3.secondary, letterSpacing: "0.1em" }}>SEASON OF {cd.egyptianSolar.season.name.toUpperCase()}</div>
                  <div style={{ fontFamily: "Cinzel,serif", fontSize: "0.9rem", color: M3.onSurface }}>{cd.egyptianSolar.season.meaning}</div>
                </div>
              </div>

              <div style={{ marginTop: 12 }}>
                {cd.egyptianSolar.isEpagomenal ? (
                  <div style={{ textAlign: "center", padding: "8px", background: M3.tertiaryContainer + "22", borderRadius: 8 }}>
                    <div style={{ fontFamily: "Cinzel,serif", fontSize: "1rem", color: M3.tertiary }}>Wepet Renpet</div>
                    <div style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: "0.65rem", color: M3.onSurfaceVariant }}>{cd.egyptianSolar.epagomenalDay.name} — Day {cd.egyptianSolar.epagomenalDay.n} of 5</div>
                  </div>
                ) : (
                  <>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <span style={{ fontSize: "1.2rem" }}>{cd.egyptianSolar.month.hiero}</span>
                      <div>
                        <div style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: "0.6rem", color: M3.secondary }}>MONTH {cd.egyptianSolar.month.n} ({cd.egyptianSolar.month.greek})</div>
                        <div style={{ fontFamily: "Cinzel,serif", fontSize: "1.1rem", color: M3.primary }}>{cd.egyptianSolar.month.name}</div>
                      </div>
                    </div>
                    <div style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: "0.75rem", color: M3.onSurface, marginTop: 4 }}>
                      Day {cd.egyptianSolar.dayOfMonth} · Decan {cd.egyptianSolar.decan === 1 ? "I" : cd.egyptianSolar.decan === 2 ? "II" : "III"}
                    </div>
                  </>
                )}
              </div>
            ...
            {/* Deity Info */}
            <div style={{ background: M3.surfaceVariant + "44", padding: "12px", borderRadius: 12, border: `1px solid ${M3.outlineVariant}`, display: "flex", flexDirection: "column", justifyContent: "center" }}>
              {cd.egyptianSolar.isEpagomenal ? (
                <>
                  <div style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: "0.6rem", color: M3.secondary, letterSpacing: "0.15em" }}>DIVINE BIRTHDAY</div>
                  <div style={{ fontFamily: "Cinzel,serif", fontSize: "1.1rem", color: M3.tertiary, margin: "4px 0" }}>{cd.egyptianSolar.epagomenalDay.deity}</div>
                  <p style={{ fontFamily: "'EB Garamond',Georgia,serif", fontSize: "0.65rem", color: M3.onSurfaceVariant, margin: 0, fontStyle: "italic", lineHeight: 1.4 }}>
                    {cd.egyptianSolar.epagomenalDay.desc}
                  </p>
                </>
              ) : (
                <>
                  <div style={{ fontFamily: "'Share Tech Mono',monospace", fontSize: "0.6rem", color: M3.secondary, letterSpacing: "0.15em" }}>PRESIDING DEITY</div>
                  <div style={{ fontFamily: "Cinzel,serif", fontSize: "1.1rem", color: M3.primary, margin: "4px 0" }}>{cd.egyptianSolar.month.deity}</div>
                  <p style={{ fontFamily: "'EB Garamond',Georgia,serif", fontSize: "0.65rem", color: M3.onSurfaceVariant, margin: 0, fontStyle: "italic", lineHeight: 1.4 }}>
                    {cd.egyptianSolar.month.deityDesc}
                  </p>
                </>
              )}
            </div>
          ...
          <p style={{ fontFamily: "'EB Garamond',Georgia,serif", fontSize: "0.68rem", color: M3.onSurfaceVariant, marginTop: 12, textAlign: "center", borderTop: `1px solid ${M3.outlineVariant}`, paddingTop: 8 }}>
            {cd.egyptianSolar.season.desc}
          </p>
        </Card>
      )}
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 4, marginBottom: 10 }}>
          {["all", "sambraielic", "norse", "roman", "christian", "orthodox", "kemetic", "hindu", "buddhist", "vodou", "shinto", "eastern", "greek", "neopagan"].map(t => (
            <button key={t} onClick={() => setCalHolFilter(t)}
              style={{
                padding: "3px 10px", borderRadius: 14, border: `1px solid ${calHolFilter === t ? M3.primary : M3.outlineVariant}`,
